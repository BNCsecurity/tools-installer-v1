...
print " "
print "                      $$$$$$$$$$$$$$$$$$$"
print "                      $ tools by gantai $"
print "                      $  hanya seorang  $"
print "                      $   N E W B I E   $"
print "                      $   089630058754  $"
print "                      $$$$$$$$$$$$$$$$$$$"
print " "
print "           jika tools mengalami eror saat di pilih .." 
print "                     mohon hubungi saya.."
print " "
print "          ini hanya installer tools , atau tools untuk menginstall..."
print "           jadi .. jika ingin menggunakan tools yang sudah di install"
print "            anda ketik cd setelah itu ketik ls .. anda tinggal cari "
print "             nama tools yang anda install ..................."
                                        
"""
backtomenu_banner = """
  [99] Back to main menu
  [00] Exit the BNCtools
"""
def restart_program():
...
def backtomenu_option():
	...
	if backtomenu == "99":
		...
		print "\nERROR: command yang anda masukan salah ! "
		time.sleep(2)
		restart_program()
